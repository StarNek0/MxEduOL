# coding:utf8
"""
Django settings for MxEduOL project.
...
sys.path.insert(0, os.path.join(BASE_DIR, 'apps'))  # 用于解决命令行中由于更改了路径导致无法搜索到资源文件的问题
...
WSGI_APPLICATION = 'MxEduOL.wsgi.application'
